...
+
Documentazione per il software Astra Control Center implementato presso la sede del cliente.

* https://docs.netapp.com/us-en/astra-control-service/["Documentazione del servizio Astra Control"^]
+
Documentazione per il software Astra Control Service disponibile nel cloud pubblico.

* https://docs.netapp.com/us-en/trident/["Documentazione di Astra Trident"^]
+
Documentazione per lo storage open source Astra Trident orchestrator gestito da NetApp.
...
== Concetti REST e tecnologia cloud
